...
- **Webhook Actions**: Configure the agent to fetch dynamic information, such as current product availability and prices, from your backend systems instead of hardcoding them.
