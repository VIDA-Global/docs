...
2. **Conditional Call Forwarding**:
   ...
   - To enable conditional call forwarding on your mobile number, go to **Settings -> Call Forwarding** in your Vida account. Follow the instructions to enable cellular forwarding to your Vida AI phone agent.
...
1. **Ad Campaign Integration**:
   - Use the Vida AI phone agent number in your call-based advertising campaigns. Vida provides insights into why customers are calling and helps you evaluate the return on investment (ROI) of your ads. Each call is captured as a lead, which can be managed via Vida's Knowledge skill or Messaging feature.
...
1. **Share Its Public Profile Page**:
   - Share your agent's public profile page. Your public link will look like this: https://vida.io/{{yourAgentUsernameHere}}. Check out our [profile guide](/docs/sharing/profile) for more information.
