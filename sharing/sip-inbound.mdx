...
Before your Vida agent will accept a call over SIP, you need to add your IPs to your SIP IP Access list. You can do this [via API](/api-reference/sip/list-sip-ip-whitelist) or via the [https://vida.io/inbox?settings=true&tab=api](Developer page in Settings).
