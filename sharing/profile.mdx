...
https://vida.io/agentName

Replace `agentName` with your actual agent's username.

By sharing this link, you enable your customers to access your AI agent's services conveniently through a web interface.

Want to do more? Embed your AI agent into your website so people can talk to it without leaving your page. Visit our [Embed Instructions](/sharing/embed) page for more information.