...
You can find your public profile link by visiting if logged in: [https://vida.io/inbox?shareProfile=true](https://vida.io/inbox?shareProfile=true).
...
"https://vida.io/{{yourAgentUsernameHere}}"

Replace `{{yourAgentUsernameHere}}` with your actual agent's username.
