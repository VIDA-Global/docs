...
| **billedQuantity**    | _integer_           | 126                      | Billed quantity of the product item unit of measure (e.g. minutes, messages, or token counts) the Vida system billed the organization level. This may not match what your system will use for billing increments. See quantity.                                             |
...
| **direction**         | text                | inbound                  | The direction of the AI agent conversation that produced this billing event. For example, if the agent received a call, this field would show as "inbound".  Valid values: <br /><br />"inbound" or "outbound"                                                              |
| **billedAddress**     | text                | \+14405559999            | Similar to a Billing Telephone Number (BTN), this field indicates which src or dest address was the billed party address.                                                                                                                                                   |
