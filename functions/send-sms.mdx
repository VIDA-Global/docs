...
The Send SMS function allows your agent to send an sms with any content to any destination phone number. This allows your agent to send requested information to callers such as custom booking links. This function is different than the Notify function sms in which the Send SMS function can be used during or after agent conversation (just be specific in the instructions when you want the function to be used).
