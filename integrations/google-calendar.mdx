...
4. **Customize Event Details:** In the Schedule Function, you can define what information you want to go into the Event Title and Description.

## Availability Configuration

In your agent prompt, you can control when the agent is able to schedule appointments:

* e.g. "Appointments can be scheduled from Monday through Friday, 9am to 6pm.  Each event should be 30 minutes long, scheduled at the :00 or the :30 mark of each hour."

* The agent will use this availability in conjunction with the Google Calendar to determine when meetings can be scheduled.  If the requested time is unavailable, your agent will work with the caller to find a suitable solution.

* You can also tell your agent to suggest the next available time to the caller, or ask the caller for a day and then suggest available times.
