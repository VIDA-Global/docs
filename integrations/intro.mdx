...
To enable Google Calendar and access Zapier integration options, visit our [Integration Settings Page](https://vida.io/app/integrations?page=inbox&filter=priority).
...
Basic integrations are included in our Business Growth tier plans.
...
Premium integrations are included in our Business Premium tier plans.
